...
Release tracking: [issue #26](https://github.com/hygentlemen/calinmeters-website/issues/26) is the live checklist for PR merge, Pages deployment, production checks and sitemap readback. Its completion comment records these post-commit results. Local evidence and operational deferrals are recorded in [the weekly handoff](../../weekly/2026-09-14.md).
